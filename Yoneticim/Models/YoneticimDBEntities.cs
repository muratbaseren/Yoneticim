...
namespace Yoneticim
{
    ...
    public partial class YoneticimDBEntities : DbContext
    {
        ...
        {
            Database.SetInitializer(new YoneticimDBInit());
        }

        public virtual DbSet<Daire> Daireler { get; set; }
        public virtual DbSet<Gorevli> Gorevliler { get; set; }
        public virtual DbSet<GorevliTuru> GorevliTurleri { get; set; }
        public virtual DbSet<Kalem> Kalemler { get; set; }
        public virtual DbSet<Mulk> Mulkler { get; set; }
        public virtual DbSet<Yonetici> Yoneticiler { get; set; }


    }

    public class YoneticimDBInit:CreateDatabaseIfNotExists<YoneticimDBEntities>
    {
        protected override void Seed(YoneticimDBEntities context)
        {
            InsertSampleYoneticiler(context);
            InsertSampleGorevliTurleri(context);
            InsertSampleSiteAndAparts(context);
            InsertSampleBlocks(context);
            InsertSampleFlats(context);
            InsertSampleStaff(context);
            InsertSampleFinancialItems(context);
        }
